...
public class ButtonController implements EventHandler<ActionEvent> {
  ...
  /**
   * Constructor that holds the deckOfCards, cardView and popup.
   *
   * @param deckOfCards the deck of cards.
   * @param cardView the view of the cards.
   * @param popup the popup class.
   */
  public ButtonController(
      DeckOperation deckOfCards, CardViewInterface cardView, PopupInterface popup) {
  ...
  /**
   * The event handler for the 'deal hand' button. Will display cards that are accessed through
   * {@code deckOfCards.getHand()}.
   */
