...
public class CardImage {
  ...
  /**
   * Constructor that will set the path and file extension of images.
   * Does also initiate a HashMap and the imageLoader function.
   */
  public CardImage() {
  ...
  /**
   * Function that loads all images into a HashMap.
   * The key represents the name of the file, and the value is an image.
   */
