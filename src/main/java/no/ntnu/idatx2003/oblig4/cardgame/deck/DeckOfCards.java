...
public class DeckOfCards implements DeckOperation {
  ...
  /**
   * Constructor that instantiates 52 {@code PlayingCard} objects. The 52 cards does represent a
   * deck of cards.
   */
  public DeckOfCards() {
  ...
  /**
   * Function that deals a random hand of cards. The cards will be added into the hand.
   *
